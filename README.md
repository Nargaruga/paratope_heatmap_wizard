...
- by writing `wizard paratope` in the PyMOL console;
- by going to `Wizard->Paratope Heatmap` in the external GUI (or the internal one, if in VR mode);

## Detecting the Paratope
